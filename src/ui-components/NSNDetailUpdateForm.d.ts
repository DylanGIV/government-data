...
export declare type NSNDetailUpdateFormInputValues = {
    nsn?: string;
    niin?: string;
    itemName?: string;
    inc?: string;
...
export declare type NSNDetailUpdateFormValidationValues = {
...
export declare type NSNDetailUpdateFormOverridesProps = {
    NSNDetailUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type NSNDetailUpdateFormProps = React.PropsWithChildren<{
    overrides?: NSNDetailUpdateFormOverridesProps | undefined | null;
} & {
    nsn?: string;
    nSNDetail?: NSNDetail;
    onSubmit?: (fields: NSNDetailUpdateFormInputValues) => NSNDetailUpdateFormInputValues;
    onSuccess?: (fields: NSNDetailUpdateFormInputValues) => void;
    onError?: (fields: NSNDetailUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: NSNDetailUpdateFormInputValues) => NSNDetailUpdateFormInputValues;
    onValidate?: NSNDetailUpdateFormValidationValues;
} & React.CSSProperties>;
export default function NSNDetailUpdateForm(props: NSNDetailUpdateFormProps): React.ReactElement;
