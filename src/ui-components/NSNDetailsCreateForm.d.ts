...
export declare type NSNDetailsCreateFormInputValues = {
    nsn?: string;
    niin?: string;
    itemName?: string;
    inc?: string;
...
export declare type NSNDetailsCreateFormValidationValues = {
...
export declare type NSNDetailsCreateFormOverridesProps = {
    NSNDetailsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type NSNDetailsCreateFormProps = React.PropsWithChildren<{
    overrides?: NSNDetailsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: NSNDetailsCreateFormInputValues) => NSNDetailsCreateFormInputValues;
    onSuccess?: (fields: NSNDetailsCreateFormInputValues) => void;
    onError?: (fields: NSNDetailsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: NSNDetailsCreateFormInputValues) => NSNDetailsCreateFormInputValues;
    onValidate?: NSNDetailsCreateFormValidationValues;
} & React.CSSProperties>;
export default function NSNDetailsCreateForm(props: NSNDetailsCreateFormProps): React.ReactElement;
