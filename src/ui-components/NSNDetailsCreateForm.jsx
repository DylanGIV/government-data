...
export default function NSNDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNiin(initialValues.niin);
    setItemName(initialValues.itemName);
    setInc(initialValues.inc);
    setFsc(initialValues.fsc);
    setAssignmentDate(initialValues.assignmentDate);
    setCrit(initialValues.crit);
    setIig(initialValues.iig);
    setIsc(initialValues.isc);
    setDateStandardized(initialValues.dateStandardized);
    setHmic(initialValues.hmic);
    setDodic(initialValues.dodic);
    setNsc(initialValues.nsc);
    setCancellationDate(initialValues.cancellationDate);
    setPmic(initialValues.pmic);
    setFiig(initialValues.fiig);
    setEsd(initialValues.esd);
    setScheduleB(initialValues.scheduleB);
    setDemil(initialValues.demil);
    setDemilint(initialValues.demilint);
    setTiic(initialValues.tiic);
    setOriginator(initialValues.originator);
    setAdpec(initialValues.adpec);
    setRpdmrc(initialValues.rpdmrc);
    setErrors({});
  };
  const validations = {
    nsn: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new NSNDetails(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "NSNDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Nsn"
